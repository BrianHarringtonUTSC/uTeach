...
var threads = []*Thread{&Thread{"random_post", "Some random tutorial on for loops", "Here's a random link to said random tutorial on for loops", "python", "for_loops"}}
...
func GetThread(subjectName string, topicName string, threadName string) *Thread {
	return threads[0]
}
